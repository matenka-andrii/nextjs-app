...
const StartupForm = () => {
    ...
    return (
        <form action={formAction} className="startup-form">
            <div>
                <label htmlFor="tittle" className="startup-form_label">Title</label>
                <Input id="tittle" name="title" className="startup-form_input" required placeholder="Startup Title" />
