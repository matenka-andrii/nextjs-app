...
const Page = async ({ params }: { params: Promise<{ id: string }> }) => {
    ...
    return (
        <>
            <section className="green_container pattern !min-h-[230px]">
            ...
            <section className="section_container">
                ...
                <div className="space-y-5 mt-10 max-w-4xl mx-auto">
                    ...
                    { parsedContent
                        ? ( <article className="prose max-w-4xl font-work break-all" dangerouslySetInnerHTML={{ __html: parsedContent }} /> )
